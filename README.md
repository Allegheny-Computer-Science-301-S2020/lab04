...
## Objectives
  ...
  1. The objectives of this group work is to gain some practice in asking exploratory questions concerning the pitcher-batter relationship in baseball and using data analysis to respond to these questions.  

  2. To enhance your understanding of how to work in groups to investigate research questions, locate and wrangle data and create plots to show that non-random events are in place to explain the pitcher-batter relationship.
